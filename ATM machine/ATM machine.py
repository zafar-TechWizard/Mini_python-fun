...
def wishMe():
    ...
    if hour >= 0 and hour < 12:
        speak(f"Good-Morning, welcome to the virtual ATM machine")

    elif hour >=12 and hour < 17:
        speak(f"Good Afternoon Sir, welcome to the virtual ATM machine")

    if hour >=17 and hour <20:
        speak(f"good-evening dear, welcome to the virtual ATM machine ")

    elif hour >=20 and hour <0:
        speak(f"good night Sir, welcome to the virtual ATM machine")
        speak("sir,....you may not have a good experience this time As this is the time to relax")    
